...
const LEADERBOARD_DATA = [
    { rank: 1, name: "ContextKing", score: 2600, avatar: "bg-cyan-500" },
    { rank: 2, name: "NuanceNinja", score: 2450, avatar: "bg-emerald-500" },
    { rank: 3, name: "WordSmith", score: 2200, avatar: "bg-purple-500" },
    { rank: 4, name: "Polyglot", score: 2050, avatar: "bg-amber-500" },
];
...
const ResultsDashboard: React.FC<ResultsDashboardProps> = ({ stats, onPlayAgain, onExit }) => {
    ...
    let performanceTitle = "Interpreter";
    if (percentage === 100) performanceTitle = "Omniscient";
    else if (percentage >= 80) performanceTitle = "Linguist";
    else if (percentage >= 60) performanceTitle = "Translator";
        ...
        <div className="w-full h-full max-w-4xl mx-auto flex flex-col items-center justify-start md:justify-center animate-in zoom-in-95 duration-700 py-8 overflow-y-auto px-4">
            ...
            <div className="w-full grid grid-cols-1 md:grid-cols-12 gap-6 mb-8">
                ...
                <div className="md:col-span-7 bg-[#18181b] rounded-[2rem] p-8 border border-white/5 relative overflow-hidden shadow-2xl flex flex-col justify-between min-h-[400px]">
                    <div className="absolute top-0 right-0 w-64 h-64 bg-analogyai-secondary/10 rounded-full blur-[80px] pointer-events-none" />

                    <div className="relative z-10">
                        <div className="flex items-center gap-2 mb-2">
                            <Sparkles className="h-5 w-5 text-analogyai-secondary animate-pulse" />
                            <span className="text-xs font-bold text-zinc-500 uppercase tracking-widest">Context Analysis Complete</span>
                        </div>
                        <h2 className="text-5xl md:text-6xl font-black text-white tracking-tighter mb-1">
                            {stats.score}
                        </h2>
                        <p className="font-mono text-sm text-analogyai-secondary font-bold">Total Score.</p>
                    </div>

                    <div className="relative z-10 py-8">
                        <p className="text-zinc-500 text-sm font-medium mb-2">Linguistic Precision</p>
                        <h3 className="text-3xl md:text-4xl font-serif italic text-white leading-tight">
                            "Intuitive <span className="text-transparent bg-clip-text bg-gradient-to-r from-analogyai-secondary to-emerald-400">{performanceTitle}</span>"
                        </h3>
                        <div className="h-1 w-24 bg-zinc-800 mt-4 rounded-full overflow-hidden">
                            <div className="h-full bg-analogyai-secondary" style={{ width: `${percentage}%` }} />
                        </div>
                    </div>
                ...
                <div className="md:col-span-5 flex flex-col gap-6">
                    ...
                    <div className="bg-[#18181b] rounded-[2rem] p-6 border border-white/5 shadow-xl flex-1 flex flex-col">
                        <div className="flex items-center gap-2 mb-4">
                            <TrendingUp className="h-4 w-4 text-analogyai-secondary" />
                        ...
                        <div className="flex-1 w-full min-h-[120px]">
                            <ResponsiveContainer width="100%" height="100%">
                                <AreaChart data={graphData}>
                                    <defs>
                                        <linearGradient id="scoreGradientCyan" x1="0" y1="0" x2="0" y2="1">
                                    ...
                                    />
                                    <Area type="monotone" dataKey="score" stroke="#22d3ee" strokeWidth={3} fill="url(#scoreGradientCyan)" />
                                </AreaChart>
                            </ResponsiveContainer>
                        </div>
                    </div>
                    ...
                    <div className="bg-[#EFEFEF] dark:bg-[#000] rounded-[2rem] p-6 border border-zinc-200 dark:border-zinc-800 relative">
                        ...
                        <div className="flex justify-between items-center mb-4">
                            ...
                            <span className="text-xs font-mono font-bold text-analogyai-secondary">RANK #87</span>
                        </div>
